...
echo "singularity exec -B /scratch:/scratch /scratch/tacc/images/homer_4.9.1--pl5.22.0_5.img annotatePeaks.pl $peakFile $runthis > homerAnnoOut/${smpId}_Anno.txt"
singularity exec -B /scratch:/scratch /scratch/tacc/images/homer_4.9.1--pl5.22.0_5.img annotatePeaks.pl $peakFile $runthis > homerAnnoOut/${smpId}_Anno.txt



ls | grep -v homerAnnoOut | grep -v "\.err" | grep -v "\.out" | grep -v ipcexe | xargs rm -rf
trap "ls | grep -v homerAnnoOut | grep -v "\.err" | grep -v "\.out" | grep -v ipcexe | xargs rm -rf" exit
